public class HeronsFormula {
  public static void main( String[] args) {
    ...
    // Adding a test to find area of a triangle with sides 9,9,9 was as easy
    // as adding a new line of code with the  specific parameters to line 17
    // Adding it without the function would have involved adding wuite a few
    // more lines of code.
  }
  ...
  public static double triangleArea( int a, int b, int c) {
    ...
    return A;
    // The version not using a function is 20 lines of code longer.
  }
}
